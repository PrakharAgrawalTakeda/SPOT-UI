...
export class MyPreferenceApiService {
    ...
    async DeleteLink(projectId: string) {
        var url =
            GlobalVariables.apiurl + 'ProjectHubData/DeleteLink/' + projectId;
    ...
    async getMasterStandardMilestoneSets(userId: string) {
        var userid =
            GlobalVariables.apiurl +
            'StandardMilestoneSet/GetMasterTemplates/' +
            userId;
    ...
    async editMetricRepository(projectId: string, body) {
        var link =
            GlobalVariables.apiurl + 'MetricRepository/' + projectId + '/';
    ...
    async checkAccess(userId: string) {
        var userid =
            GlobalVariables.apiurl +
            'StandardMilestoneSet/CheckAccess/' +
            userId;
        const abc$ = this.http.get(userid);
        const response = await lastValueFrom(abc$);
        return response;
    ...
    async getDetails(userId: string) {
        var userid =
            GlobalVariables.apiurl +
            'StandardMilestoneSet/GetDetails/' +
            userId;
        const abc$ = this.http.get(userid);
        const response = await lastValueFrom(abc$);
        return response;
    ...
    async editStandardMilestoneSet(body, projectId) {
        var link =
            GlobalVariables.apiurl + 'StandardMilestoneSet/Edit/' + projectId;
        const abc$ = this.http.put(link, body);
        const response = await lastValueFrom(abc$);
        return response;
    }
    ...
    async GetPortfolioOwnerForPreferences(id) {
        var link =
            GlobalVariables.apiurl +
            'PortfolioOwner/GetPortfolioOwnersForPreferences/' +
            id;
        const abc$ = this.http.get(link);
        const response = await lastValueFrom(abc$);
        return response;
    ...
    async metricRepositorySingle(itemid: string) {
        var userid =
            GlobalVariables.apiurl + 'StrategicMetricRepository/' + itemid;
        const abc$ = this.http.get(userid);
        const response = await lastValueFrom(abc$);
        return response;
    }
    ...
    async getemailNoti(userid: string) {
        var url =
            GlobalVariables.apiurl +
            'EmailNotificationsSettings/ByUserADId/' +
            userid;
        const abc$ = this.http.get(url);
        const response = await lastValueFrom(abc$);
        return response;
    ...
    async getPortifolioCenterTilePreferencesByUser(userId: string) {
        var url =
            GlobalVariables.apiurl +
            'PortfolioCenterTilePreferences/GetPortfolioCenterTilePreferencesByUser/' +
            userId;
        const abc$ = this.http.get(url);
        const response = await lastValueFrom(abc$);
        return response;
    ...
    async addPortfolioCenterTilePreferences(body) {
        var link = GlobalVariables.apiurl + 'PortfolioCenterTilePreferences';
        const abc$ = this.http.post(link, body);
        const response = await lastValueFrom(abc$);
        return response;
    }
