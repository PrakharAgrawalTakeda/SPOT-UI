...
@Component({
    selector: 'app-planning-team-bulk-edit',
    templateUrl: './planning-team-bulk-edit.component.html',
    styleUrls: ['./planning-team-bulk-edit.component.scss']
})
export class PlanningTeamBulkEditComponent implements OnInit {
