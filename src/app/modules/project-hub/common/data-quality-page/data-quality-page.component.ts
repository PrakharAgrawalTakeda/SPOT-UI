...
import { QUALITY_TARGET_PERCENTAGE } from '../../../../shared/constants'
...
export class DataQualityPageComponent implements OnInit {
  ...
  targetPercentage: number = QUALITY_TARGET_PERCENTAGE;
  columns = [{name:'Phase', prop: 'phase', sortable:false, width:"200px"}, { name: 'Requirement' , prop:'requirement',sortable:false}, { name: 'Hit/Miss', prop:'hitMiss', cellClass: getCellClass, sortable:false}, {name: 'Detailed Description', prop:'detailedDescription', sortable:false, width: "auto"}];
  ...
  dataloader() {
    ...
    this.apiService.getDataCompleteness(this.id).then((res: any) => {
      ...
      this.targetPercentage = res.targetPercentage*100;
    })
  }
