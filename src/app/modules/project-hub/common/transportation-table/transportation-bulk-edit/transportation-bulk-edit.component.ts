  ...
  changeChecker() {
    ...
    formValue.length > 0 ? this.submitObj = formValue.map(x => {
      return {
        ...
        shipmentWeight: x.shipmentWeight == null || x.shipmentWeight == 0 ? 0 : x.shipmentWeight,
        shipmentFrequency: x.shipmentFrequency == null || x.shipmentFrequency == 0 ? 0 : x.shipmentFrequency,
